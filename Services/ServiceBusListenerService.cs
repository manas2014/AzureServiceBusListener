...
namespace mvp.Services
{
    public class ServiceBusListenerService : IHostedService {
        ...
        public ServiceBusListenerService(IConfiguration configuration, ILoggerFactory loggerFactory)
        {
            this.logger = loggerFactory.CreateLogger<ServiceBusListenerService>();
